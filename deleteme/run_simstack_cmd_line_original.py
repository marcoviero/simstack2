...
from skycatalogs import Field_catalogs
...
def main():
    ...
    for i in range(n_slices):
        ...
        sky_dictionary = get_maps(params)
        ...
        for iboot in np.arange(params['number_of_boots']) + params['boot0']:
            ...
            if params['float_background'] == True:
                stacked_flux_densities = stack_dictionaries_in_layers_w_background(sky_dictionary, binned_ra_dec)
            else:
                stacked_flux_densities = stack_dictionaries_in_layers(sky_dictionary, binned_ra_dec)
...
def get_maps(params):
    ...
    for t in params['dictionary_keys']:
        ...
        sky_dictionary[t] = sky
    return sky_dictionary
